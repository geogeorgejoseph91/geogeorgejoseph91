...
#### **Frontend Engineering & UI Leadership**
<p align="left">
...
* 📊 **Retail Business Intelligence Dashboard (Power BI)**: Implementing professional-grade profitability modeling (Net Profit, COGS, OpEx) using dynamic DAX measures and robust star schema modeling.
* 📉 **Regression Dashboard Validation**: Engineering user-friendly validation architectures in predictive modeling dashboards to enforce strict input data guarantees and targets.
* 🎨 **Figma to Drupal Component Systems**: Authoring BEM-compliant layouts, Twig components, and Storybook integrations using modern design system tokens.
...
- 💼 **LinkedIn**: [linkedin.com/in/geo-george-joseph](https://www.linkedin.com/in/geo-george-joseph/)
- 📧 **Email**: [geogeorge91@gmail.com](mailto:geogeorge91@gmail.com)
- 🌐 **Location**: Ernakulam, Kerala, India (PIN: 683544)
